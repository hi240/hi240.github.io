...
public class Bank {
	...
	private HashMap<String,String> accountNoSet1;
	Scanner sc = new Scanner(System.in);

	Bank() {
		accounts = new ArrayList<Account>();
		totalAccount = 0;
		this.accountNoSet1 = new HashMap<String,String>();
	}
	// 계좌를 생성한다
	public void addAccount(String accountNo, String name) {
		accounts.add(new Account(accountNo, name));
		accountNoSet1.put(accountNo,name);
	...
	void programB() {
		outer: while (true) {
			...
			case 1: {
				...
				if(!accountNoSet1.containsKey(accountNo)) {
					break;
				}				
				}
