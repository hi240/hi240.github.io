	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="border js-fullheight">
			<div class="text-center">
				<div class="author-img" style="background-image: url(images/about.jpg);"></div> <!-- 이미지이이이이 -->
				<h1 id="colorlib-logo"><a href="index.html">5조5조</a></h1>
				<span class="position"><a href="#">첫번째 메뉴</a> in BitCamp</span>
			</div>
			<nav id="colorlib-main-menu" role="navigation" class="navbar">
				<div id="navbar" class="collapse">
					<ul>
						<li class="active"><a href="#" data-nav-section="home">5조다아아</a></li>
						<li><a href="#" data-nav-section="about">김덕기</a></li>
						<li><a href="#" data-nav-section="services">채현아</a></li>
						<li><a href="#" data-nav-section="skills">박정수</a></li>
						<li><a href="#" data-nav-section="education">이서영</a></li>
						<li><a href="#" data-nav-section="experience">김형원</a></li>
						<!-- 			
